...
if ! "$PY" -c "from pixel_patrol_deepsea.analyse import ffmpeg; ffmpeg()" 2>/dev/null; then
    echo "== ffmpeg"
...
"$PY" -c "from pixel_patrol_deepsea.analyse import ffmpeg; print('   ffmpeg     : ' + ffmpeg())"
